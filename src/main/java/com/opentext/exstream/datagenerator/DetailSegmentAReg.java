...
///```
public class DetailSegmentAReg extends AbstractDetailReg {

    public DetailSegmentAReg(String holder, Date date, float initialBalance) {
        super(RegistryType.DETAIL_SEGMENT_A, holder, date, initialBalance);
    }
}
